...
[.lead]
*Automation tools for https://eu.fsastech.com/de/produkte-services/primergy-servers/infrastrukturmanager-ism/[Infrastructure Manager (ISM)] using REST API.*
...
+ Additional option for `ism_get_sysrep` to upload it to Fsas Technologies SFTP server +
...
$ ism_show_isos
 ID Filename                                                                MiB
=== ==================================================================== ======
  9 VMware-ESXi-7.0.3.update03-19193900-Fsas-v530-1.iso                  440
  2 VMware-ESXi-6.7.0-14320388-Fsas-v480-1.iso                           376
 ...
 11 SLE-15-SP4-Full-x86_64-GM-Media1.iso                                  12438
  ...
  7 VMware_ESXi_7.0.0_15843807_Fsas_v500_1.iso                           369
  8 VMware-ESXi-7.0.1.update01-16850804-Fsas-v510-1.iso                  389
----
...
$ ism_del_iso
 ID Filename
=== ==============================
  9 VMware-ESXi-7.0.3.update03-19193900-Fsas-v530-1.iso
  2 VMware-ESXi-6.7.0-14320388-Fsas-v480-1.iso
 ...
 11 SLE-15-SP4-Full-x86_64-GM-Media1.iso
  ...
  7 VMware_ESXi_7.0.0_15843807_Fsas_v500_1.iso
  8 VMware-ESXi-7.0.1.update01-16850804-Fsas-v510-1.iso
